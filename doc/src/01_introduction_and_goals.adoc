...
Zum original https://github.com/web-programming-lab/web-programming-lab-projekt/tree/main[Projektauftrag]

=== Aufgabenstellung

Der Technologie-Radar ist ein passendes Werkzeug für Technologie-Management in einem Unternehmen, für ein Produkt-Team oder auch für sich als Softwarearchitekt oder Software Engineer. Es gibt bereits verschiedene Umsetzungen von Technologie-Radare. Das prominenteste Beispiel ist der https://www.thoughtworks.com/de-de/radar[Technology Radar] von ThoughtWorks.
...
|===
| Name | Rolle | Kontakt | Erwartungshaltung

| Dominik Witschard
| _Modulverantwortlicher_
| _https://github.com/dwitschard[Github]_
| _Erfüllen aller funktionaler und nicht funktionaler Anforderungen._
|===
